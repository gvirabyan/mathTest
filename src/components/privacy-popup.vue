<template>
  <div class="about-us-popup">
    ...
    <f7-block>
      <f7-block-title>{{ $t("profile.about-us.privacy") }}</f7-block-title>
    </f7-block>
    <f7-block>
      <div style="padding: 0 16px 10px; height: calc(100vh - 112px); overflow: auto">
        <p>
          Diese Datenschutzrichtlinie beschreibt, wie MatheApp personenbezogene Daten sammelt, verwendet und weitergibt.
        </p>

        <f7-block-title>Einführung</f7-block-title>
        <p>
          Wir, das Team von MatheApp, nehmen den Schutz Ihrer persönlichen Daten sehr ernst und halten uns strikt an die
          Regeln der Datenschutzgesetze. Diese Datenschutzerklärung dient dazu, Sie über die Art, den Umfang und den
          Zweck der Erhebung und Verwendung personenbezogener Daten durch unsere mobile Anwendung MatheApp zu
          informieren.
        </p>
        <h3>Erhebung und Verarbeitung personenbezo</h3>
        <p>
        ...
        <h3>Cookies</h3>
        <p>MatheApp verwendet keine Cookies oder ähnliche Technologien zur Erfassung persönlicher Daten.</p>
        <h3>Nutzung von Diensten Dritter</h3>
        <p>
          Unsere App nutzt verschiedene Dienste Dritter, um die Funktionalität zu verbessern und das Benutzererlebnis zu
          optimieren:
        </p>
        <ul>
          <li>
            <p>Microsoft Clarity für Analyse und Nutzerverhalten</p>
          </li>
          <li>
            <p>Google Analytics für Analyse und Nutzerverhalten</p>
          </li>
          <li>
            <p>Google Places API für Ortsinformationen</p>
          </li>
        </ul>
        <p>
          Bitte beachten Sie, dass diese Dienste eigene Datenschutzrichtlinien haben, die unabhängig von unserer
          Datenschutzerklärung sind. Wir empfehlen Ihnen, sich mit diesen Richtlinien vertraut zu machen.
        </p>
        <h3>Löschung von Daten</h3>
        <p>
          Benutzer, die wünschen, dass ihre Daten aus unserer Anwendung gelöscht werden, können dies durch eine
          Nachricht über das Kontaktformular auf unserer Website https://schulmatheapp.de beantragen. Wir werden die
          entsprechenden Daten unverzüglich löschen und bestätigen die Löschung.
        </p>
        <h3>Sicherheit</h3>
        <p>
          Wir treffen technische und organisatorische Sicherheitsmaßnahmen, um Ihre Daten gegen zufällige oder
          vorsätzliche Manipulation, Verlust, Zerstörung oder den Zugriff unberechtigter Personen zu schützen. Unsere
        ...
        <p>
          ...
          Anforderungen entspricht oder um Änderungen unserer Dienste in der Datenschutzerklärung umzusetzen. Für Ihren
