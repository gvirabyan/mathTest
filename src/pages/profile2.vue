<template>
  <f7-page class="hg-profile-content" name="profile">
    ...
    <f7-list class="profile-form" inline-labels no-hairlines-md>
      ...
      <f7-list-input v-model:value="profileData.name" label="Name" type="text" placeholder="Your name" clear-button />
      ...
      <f7-block>
        <f7-button color="blue" fill :disabled="disableSubmit" @click="editProfile">Edit</f7-button>
      </f7-block>

      <f7-sheet class="calendar-sheet" :opened="isCalendarOpened" backdrop @sheet:closed="closeCalendar">
        <f7-toolbar>
          <div class="left"></div>
          <div class="right">
